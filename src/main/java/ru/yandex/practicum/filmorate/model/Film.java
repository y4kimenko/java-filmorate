...
import lombok.Data;
import ru.yandex.practicum.filmorate.model.enums.film.GenreFilm;
import ru.yandex.practicum.filmorate.model.enums.film.RatingFilm;
...
public class Film {
    ...
    @NotNull(message = "genre не должно быть пустым")
    @Size(min = 1)
